...
var (
	...
	PaletteOriginal Palette = Palette{
		baseTransparent,
		color.RGBA{0xc7, 0xf0, 0xd8, 0xff}, // Dark
		color.RGBA{0x43, 0x52, 0x3d, 0xff}, // Light
	}

	PaletteHarsh Palette = Palette{
		baseTransparent,
		color.RGBA{0x9b, 0xc7, 0x00, 0xff}, // Dark
		color.RGBA{0x2b, 0x3f, 0x09, 0xff}, // Light
	}

	PaletteGray Palette = Palette{
		baseTransparent,
		color.RGBA{0x87, 0x91, 0x88, 0xff}, // Dark
		color.RGBA{0x1a, 0x19, 0x14, 0xff}, // Light
	}
)
